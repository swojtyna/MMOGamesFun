...
public final class ViewModel: ViewModelProtocol {
    ...
    @LazyInjected
    private var getListUseCase: GetFavoritesGamesUseCase.UseCaseProtocol

    @LazyInjected
    private var addFavoriteGameUseCase: AddFavoriteGameUseCase.UseCaseProtocol

    @LazyInjected
    private var removeFavoriteGameUseCase: RemoveFavoriteGameUseCase.UseCaseProtocol
